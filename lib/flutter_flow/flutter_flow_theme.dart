...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF111111);
  late Color secondaryColor = const Color(0xFFBFF4ED);
  late Color tertiaryColor = const Color(0xFFE41655);
